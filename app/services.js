...
angular.module('Frontend.services', ['ngRoute', 'angular-jwt', 'angular-storage'])
  ...
  return{
    getProductos: function() {        
      return $http.jsonp(CONFIG.APIURL+'/todosProductos.json',{callback: 'JSON_CALLBACK'},{'Content-Type': 'application/json'});      
      /*return $http({
        method: 'get',
    ...
    getClientes: function() {
      return $http.get(CONFIG.APIURL+'/todosClientes.json');
      /*return $http({
        method: 'get',
    ...
    getTipos: function() {
      return $http.get(CONFIG.APIURL+'/todosTipos.json');
      /*return $http({
        method: 'get',
